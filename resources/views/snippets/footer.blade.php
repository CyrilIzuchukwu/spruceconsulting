    <footer class="pt-5 pb-5 sm-pt-40px sm-pb-45px footer-dark bg-extra-medium-slate-blue" style="padding-inline: 30px;">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-3 col-sm-6 last-paragraph-no-margin order-5 order-sm-4 order-lg-1 text-center text-sm-start">
                    <a href="/" class="footer-logo mb-15px d-block d-lg-inline-block">
                        <img src="assets/images/demo-business-logo-white.png" style="max-height: 80px;" alt="">
                    </a>
                    <p class="w-90 sm-w-100 d-inline-block mb-15px">Lorem ipsum is consectetur adipiscing eiusmod tempor.</p>
                    <p>&COPY; 2024 <a href="/" target="_blank" class="text-white text-decoration-line-bottom">Spruce Consulting.</a></p>
                </div>
                <!-- end footer column -->
                <!-- start footer column -->
                ...
                <div class="col-7 col-lg-3 col-sm-6 xs-mb-30px last-paragraph-no-margin order-4 order-sm-5 order-lg-5">
                    ...
                    <div>
                        ...
                        <a href="" class="text-white text-decoration-line">
                            <span>
                                spruceconsulting@gmail.com
                            </span>
                        </a>
                    </div>
                </div>
