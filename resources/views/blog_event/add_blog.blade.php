                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input require type="text" value="{{ old('title') }}" name="title" class="form-control" id="a1" placeholder="Enter Blog Title">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="a1">Author </label>
                                                    <input require type="text" value="{{ old('author') }}" name="author" class="form-control" id="a1" placeholder="Author">
