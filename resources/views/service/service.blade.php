            ...
            <div class="col-sm-12 mt-5">
                <div class="card mb-3">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <div>
                            <a href="{{ route('add_service') }}" class="btn btn-danger">Add Service</a>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                                ...
                                <table class="table align-middle table-hover m-0 truncate">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-wrap: wrap;">{!! \Illuminate\Support\Str::words(strip_tags($ts->content), 20, '...') !!}</td>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <div>
                                Showing {{ $servicess->firstItem() }} to {{ $servicess->lastItem() }} of {{ $servicess->total() }} results
                            </div>
                            <div>
                                {{ $servicess->links('pagination::bootstrap-4') }}
                            </div>
                        </div>
                    </div>
