                                    ...
                                    <div class="row">
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input require type="text" value="{{ old('service_name') }}" name="service_name" class="form-control" id="a1" placeholder="Enter Service Name">
                                        ...
                                        <!-- <div class="col-sm-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" name="content" id="a8" placeholder="Enter Service Content" rows="4">{{ old('content') }}</textarea>
